...
check_file "tests/docker/Dockerfile.test.node" "tests/docker/Dockerfile.test.node"
check_file "tests/docker/Dockerfile.test.e2e" "tests/docker/Dockerfile.test.e2e"
